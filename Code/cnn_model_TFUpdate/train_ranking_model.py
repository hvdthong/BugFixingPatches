...
# USE WITHOUT BATCH NORMALIZATION SINCE WE NEED TO ADD "IS_TRAINING" IN BATCH NORMALIZATION
# Parameters
# ==================================================
# Data loading params
...
tf.flags.DEFINE_string("train_pos_data", "../data_ver1/eq100_line_aug1.pos.newcontain_maxtext150_maxcode300"
                       , "Data source for the positive training data")
tf.flags.DEFINE_string("train_neg_data", "../data_ver1/eq100_line_aug1.neg.newcontain_maxtext150_maxcode300"
                       , "Data source for the negative training data")
tf.flags.DEFINE_string("test_data", "../data_ver1/extra100_line_aug1.neg.newcontain_maxtext150_maxcode300"
                       , "Data source for the testing data, only contain negative bug fixing patches")
tf.flags.DEFINE_string("label_pos_data", "../data_ver1/lbd100_line_aug1.pos.newcontain_maxtext150_maxcode300"
                       , "Data source for the positive patches for testing data")
tf.flags.DEFINE_string("label_neg_data", "../data_ver1/lbd100_line_aug1.neg.newcontain_maxtext150_maxcode300"
                       , "Data source for the negative patches for testing data")
tf.flags.DEFINE_integer("seed", 10, "Random seed (default:123)")
tf.flags.DEFINE_float("dev_sample_percentage", .1, "Percentage of the training data to use for validation.")
...
tf.flags.DEFINE_integer("num_iters", 70000,
...
# ==================================================
# Load data
# x_text_pos, x_code_pos, x_text_neg, x_code_neg = loading_training_data(FLAGS=FLAGS)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def dev_step(left_text_batch, left_code_batch, right_text_batch, right_code_batch):
            ...
            """
            # print left_text_batch.shape, left_code_batch.shape
            # print right_text_batch.shape, right_code_batch.shape
            feed_dict = {
                cnn.input_text_left: left_text_batch,
                cnn.input_code_left: left_code_batch,
                cnn.input_text_right: right_text_batch,
