...
class CNNPatchWithDropOutNoBatchNorm_noFusionLayer(object):
    """
    ...
    def __init__(
        ...
        new_input_left = tf.concat(1, [h_pool_text_left, h_pool_code_left], name="new_input_left")
        new_input_right = tf.concat(1, [h_pool_text_right, h_pool_code_right], name="new_input_right")
